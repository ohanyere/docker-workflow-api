...
```bash
kubectl describe pod -l app.kubernetes.io/name=docker-workflow-api -n docker-workflow-api-dev
...
```bash
kubectl argo rollouts get rollout docker-workflow-api -n docker-workflow-api-dev
```
